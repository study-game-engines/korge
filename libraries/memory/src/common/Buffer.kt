...
internal fun Buffer.Companion.equalsCommon(that: Buffer, other: Any?): Boolean {
    if (other !is Buffer || that.size != other.size) return false
    return Buffer.equals(that, 0, other, 0, that.sizeInBytes)
}

internal fun Buffer.Companion.equalsCommon(src: Buffer, srcPosBytes: Int, dst: Buffer, dstPosBytes: Int, sizeInBytes: Int, use64: Boolean = true): Boolean {
...
internal fun NBuffer_toString(buffer: Buffer): String {
...
fun Buffer.Companion.allocDirect(size: Int): Buffer {
    return Buffer(size, direct = true)
}

fun Buffer.Companion.allocNoDirect(size: Int): Buffer {
    return Buffer(size, direct = false)
}
...
fun Buffer.sliceWithSize(start: Int, size: Int): Buffer {
    return sliceBuffer(start, start + size)
}
...
fun Buffer.setArray(byteOffset: Int, data: ByteArray, start: Int = 0, size: Int = data.size - start): Unit {
    arraycopy(data, start, this, byteOffset, size)
}
...
@Deprecated("", ReplaceWith("set8(index, value.toByte())"))
fun Buffer.setInt8(index: Int, value: Int) = set8(index, value.toByte())
...
val Buffer.u8: Uint8Buffer get() = asUInt8()

@Deprecated("", ReplaceWith("asUInt16()"))
val Buffer.u16: Uint16Buffer get() = asUInt16()

@Deprecated("", ReplaceWith("asInt8()"))
val Buffer.i8: Int8Buffer get() = asInt8()

@Deprecated("", ReplaceWith("asInt16()"))
val Buffer.i16: Int16Buffer get() = asInt16()

@Deprecated("", ReplaceWith("asInt32()"))
val Buffer.i32: Int32Buffer get() = asInt32()

@Deprecated("", ReplaceWith("asInt64()"))
val Buffer.i64: Int64Buffer get() = asInt64()

@Deprecated("", ReplaceWith("asFloat32()"))
val Buffer.f32: Float32Buffer get() = asFloat32()

@Deprecated("", ReplaceWith("asFloat64()"))
val Buffer.f64: Float64Buffer get() = asFloat64()
