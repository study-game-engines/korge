...
suspend fun main() = Korge {
    sceneContainer().changeTo(MainLDTKSampleScene::class)
}
            ...
            for (level in ldtk.levels) {
                container {
                    ...
                    for (layer in (level.layerInstances ?: emptyList()).asReversed()) {
                        ...
                        val tileData: StackedIntArray2 = StackedIntArray2(layer.cWid, layer.cHei, -1)
                        ...
                        for (tile in layer.autoLayerTiles) {
                            ...
                            tileData.push(x, y, TileInf(tileId, flipX = flipX, flipY = flipY, offsetX = dx, offsetY = dy).data)
                        }
