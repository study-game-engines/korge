...
@JsExport
data class Size3D(var width: Int, var height: Int = 1, var depthOrArrayLayers: Int = 1) {
    fun toArray() = arrayOf(width, height, depthOrArrayLayers)
}

data class Origin3D(var x: GPUIntegerCoordinate = 0, var y: GPUIntegerCoordinate = 0, var z: GPUIntegerCoordinate = 0) {
