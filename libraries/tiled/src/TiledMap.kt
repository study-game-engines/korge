...
class TiledMap constructor(
    ...
    data class Object constructor(
        ...
        fun toShape2dNoTransformed(): SimpleShape2D = objectShape.toShape2d()

        sealed class Shape {
            abstract fun toVectorPath(): VectorPath
            open fun toShape2d(): SimpleShape2D = toVectorPath().toShape2dNew()
            ...
            data class Rectangle(val rect: korlibs.math.geom.Rectangle) : Shape() {
                ...
                override fun toShape2d(): SimpleShape2D = rect
            }
