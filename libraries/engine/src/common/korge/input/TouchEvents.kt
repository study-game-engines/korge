...
class TouchEvents(val view: View) {
    ...
    fun Info.copyFrom(touch: Touch) = this.apply {
        this.id = touch.id
        this.global = touch.p
        this.local = view.globalToLocal(touch.p)
    }
