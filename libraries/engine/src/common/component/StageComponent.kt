...
/**
 * To use this component you have to call the [Views.registerStageComponent] extension method at the start of the APP.
 * Component with [added] and [removed] methods that are executed once the view is going to be displayed, and when the view has been removed
 */
...
private const val __VIEW_STAGE_COMPONENT_NAME: String = "__viewStageComponent"
...
fun <T : View> T.onNewAttachDetach(onAttach: Views.(T) -> Unit = {}, onDetach: Views.(T) -> Unit = {}): AutoCloseable {
    val view: T = this
    val closeable: CancellableGroup = CancellableGroup()
    val viewStageComponent: ViewStageComponent = this.viewStageComponent
...
private var Views.viewsToTrack: MutableSet<View>? by Extra.Property { null }
