...
internal open class AwtComponent(override val factory: NativeUiFactory, override val component: Component) : NativeUiFactory.NativeComponent, Extra by ExtraMixin() {
    ...
    override fun onMouseEvent(handler: (korlibs.event.MouseEvent) -> Unit): Disposable {
        ...
        fun dispatch(e: MouseEvent, type: korlibs.event.MouseEvent.Type) {
        ...
        val listener = object : MouseAdapter() {
            override fun mouseClicked(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.CLICK)
            override fun mousePressed(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.DOWN)
            override fun mouseReleased(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.UP)
            override fun mouseEntered(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.ENTER)
            override fun mouseExited(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.EXIT)
            //override fun mouseWheelMoved(e: MouseWheelEvent) = dispatch(e, korlibs.event.MouseEvent.Type.WEE)
            override fun mouseDragged(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.DRAG)
            override fun mouseMoved(e: MouseEvent) = dispatch(e, korlibs.event.MouseEvent.Type.MOVE)
        }
