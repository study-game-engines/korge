...
internal class ViewCollisionContext {
    ...
    fun collidesWith(left: View, right: View, kind: CollisionKind): Boolean {
        ...
        if (kind == CollisionKind.SHAPE) {
            val leftShape: SimpleShape2D = left.hitShape2d
            val rightShape: SimpleShape2D = right.hitShape2d
            ...
            return Shape2D.intersects(leftShape as Shape2D, ml, rightShape as Shape2D, mr)
        }
        return true
    }
}
