...
import korlibs.inject.AsyncDependency
 ...
 * Plays game sounds.
 */
class SoundMachine(private val views: View?) : InjectorDependency {
    ...
    companion object {
        operator fun invoke(injector: Injector, apply: SoundMachine.() -> Unit) {
