...
class ParticleEditorScene() : BaseEditorScene() {
    ...
    private fun repositonEmitterView() {
        ...
        if (followCursor) {
            emitterView.position(stage.mousePos)
        } else {
    ...
    override suspend fun SContainer.sceneMain() {
        ...
        uiWindow("Properties", size = Size(300.0, 500.0)) {
            ...
            uiVerticalStack(300.0) {
                ...
                uiPropertyNumberRow(
                    "RadialAcceleration",
                    *UIEditableNumberPropsList(emitter::radialAcceleration, emitter::radialAccelVariance, min = -1000.0, max = +1000.0).register()
                )
                uiPropertyNumberRow(
                    "TangentialAcceleration",
                    *UIEditableNumberPropsList(emitter::tangentialAcceleration, emitter::tangentialAccelVariance, min = -1000.0, max = +1000.0).register()
                )
                ...
                val skewProp =
                    uiPropertyNumberRow("Skew", *UIEditableNumberPropsList(emitterView::skewXDeg, emitterView::skewYDeg, min = -360.0, max = +360.0, clamped = true).register())
